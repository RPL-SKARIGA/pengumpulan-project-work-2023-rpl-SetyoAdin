  ...
  <div class="row">
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box mb-3">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Jumlah Pendaki</span>
                <span class="info-box-number">{{ $jumlahPendaki }}</span>
            </div>
            <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box mb-3">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Jumlah Gunung</span>
                <span class="info-box-number">{{ $jumlahGunung }}</span>
            </div>
            <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
