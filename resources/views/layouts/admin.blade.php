...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@10"></script>
  ...
  <style>
    ...
    .modal-body strong {
        min-width: 150px; /* Sesuaikan dengan lebar maksimum yang Anda inginkan */
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Mountnesia</span>
    </a>
...
<nav class="mt-2">
  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
      ...
      <li class="nav-item">
          <a href="/datapendaki" class="nav-link {{ Request::is('datapendaki*') ? 'active' : '' }}">
      ...
      <li class="nav-item">
          <a href="/pendataan" class="nav-link {{ Request::is('pendataan*') ? 'active' : '' }}">
              <i class="nav-icon fas fa-th"></i>
              <p>
                  Update Data
              </p>
      ...
      <li class="nav-item">
          <a href="/gunung" class="nav-link {{ Request::is('gunung*') ? 'active' : '' }}">
              <i class="nav-icon fas fa-th"></i>
              <p>
                  Data Gunung
              </p>
